window.TCI_PAGES = {
  ...
  about: {
    ...
    title: "以人与技术，成为客户长期信赖的IT伙伴",
    description: "苏州大宇宙成立于2008年，是transcosmos集团在华东地区的IT服务据点，以软件研发、信息技术服务和持续业务改善为主要业务。",
    heroImage: "team-exact-clean.jpg",
    cta: ["联系我们", "contact/"],
    lead: "客户的满意决定我们存在的价值。我们以自有团队长期参与客户业务，把人的专业判断与合适的技术结合起来，共同推动项目落地和持续改善。",
    sections: [
      {
        type: "cards",
        ...
        columns: 3,
        items: [
          { title: "2008年10月成立", text: "注册资本1,600万元，以计算机软件研发和信息技术服务为主要业务。" },
          { title: "transcosmos集团", text: "由大宇宙信息创造（中国）有限公司出资设立，是集团在华东地区的IT服务据点。" },
          { title: "苏州 · 上海 · 常州", text: "以苏州总公司及上海、常州分公司协同服务长三角和跨区域客户。" },
          { title: "265名员工", text: "截至2026年6月的整合资料数据，形成覆盖多类IT服务的自有团队。" },
          { title: "ISO27001", text: "2009年取得信息安全管理体系认证。" },
          { title: "CMMI3", text: "2010年取得软件开发过程成熟度三级认证。" }
        ]
      },
      {
        type: "cards",
        index: "02 / Business scope",
        title: "业务范围",
        columns: 3,
        items: [
          { title: "软件与定制系统开发", text: "面向工厂和办公室业务，提供需求分析、应用开发、系统集成、保守与运用。" },
          { title: "制造与物流系统", text: "覆盖WMS、MES、生产管理、现场无纸化、IoT、设备与自动搬运等场景。" },
          { title: "企业系统与数据", text: "提供SAP相关服务、低代码开发、CRM、BI分析及业务流程改善。" },
          { title: "IT基础设施与安全", text: "支持网络、服务器、数据库、云环境、监控、安全和服务台。" },
          { title: "AI与智能应用", text: "围绕生成式AI、知识库、智能体和AI辅助判断，把能力接入真实业务流程。" },
          { title: "电商与数字化支援", text: "提供电子商务、网站及相关数字业务解决方案。" }
        ]
      },
      {
        type: "split",
        index: "03 / Partnership model",
        title: "持续参与，与客户共同推进落地",
        text: "我们的服务方式不是完成一次性交付后离场，而是通过长期参与理解客户的业务流程、组织文化和现场隐性知识。由自有团队持续协作，把问题识别、系统建设、上线运营和后续改善连接起来。",
        image: "team-2255.jpg",
        bullets: ["理解真实痛点与业务背景，而不只接收表面需求", "以自有生产体制保持响应速度和交付连续性", "支持中日双语沟通与日系客户的品质要求", "陪伴系统落地、知识沉淀和长期改善"]
      },
      {
        type: "timeline",
        index: "04 / Service evolution",
        title: "从IT基础服务到AI × 业务流程改善",
        items: [
          { year: "2008起", title: "IT基础服务", text: "开展软件研发与信息技术服务，建设业务数字化基础。" },
          { year: "2009起", title: "制造业业务系统", text: "进入工厂和办公室业务，积累生产、物流与企业系统经验。" },
          { year: "2015起", title: "制造可视化与IoT", text: "连接生产数据、设备管理和现场运营。" },
          { year: "2021起", title: "自动化与DX", text: "推进无纸化、RPA和自动搬运等现场改善。" },
          { year: "2023起", title: "业务流程再造", text: "从系统建设进一步进入流程梳理与业务结构优化。" },
          { year: "2024起", title: "AI × BPR", text: "把生成式AI和智能体应用到业务流程与现场改善。" }
        ]
      },
      {
        type: "cards",
        index: "05 / Quality & security",
        title: "品质与信息安全",
        columns: 3,
        items: [
          { title: "标准化与PDCA", text: "通过标准流程、质量指标、复盘和持续改善管理项目品质。" },
          { title: "评审与项目监理", text: "设置项目评审、标准指导和监理机制，持续掌握风险与质量。" },
          { title: "测试与缺陷管理", text: "使用测试自动化与缺陷追踪工具，提高问题发现和闭环效率。" },
          { title: "知识与工程资产", text: "沉淀知识库、指导手册、模板和组件，并开展生产率评估。" },
          { title: "环境与访问控制", text: "开发与办公网络隔离，并对外网、介质、工位和出入进行管理。" },
          { title: "资料与操作审计", text: "通过保密协议、账号密码、打印和必要的操作记录保护客户信息。" }
        ]
      }
    ],
    related: []
