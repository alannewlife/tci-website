  ...
  "capabilities-ai": {
    ...
    sections: [
      ...
      },
      {
        ...
        wideMedia: true,
        bullets: [
          "业务与现场应用层：AI进入办公、研发、业务系统与制造现场的日常作业。",
          "企业公共能力与治理层：网关、身份、知识、审计与成本统一治理。",
          "Agent平台与运行层：Workflow、MCP、记忆与调度，让智能体稳定复用。",
          "模型服务层：前沿、国产、本地模型与API按场景组合选用。",
          "云与算力基础层：GPU、网络、存储与云构成算力底座。"
        ]
      },
      {
        type: "cases",
